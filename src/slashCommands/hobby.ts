...
const command: SlashCommand = {
    command: new SlashCommandBuilder().setName("hobby").setDescription("What is your hobby?"),
    execute: async (interaction) => {
        const modal = new ModalBuilder().setCustomId("hobby").setTitle("What is your hobby?");
